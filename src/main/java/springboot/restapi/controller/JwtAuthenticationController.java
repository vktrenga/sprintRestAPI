...
public class JwtAuthenticationController {
    ...
    public boolean isOtpValid(springboot.restapi.model.User user) {
        ...
        return (otpEndTimeInMillis + OTP_VALID_DURATION) > currentTimeInMillis;
    }
    ...
    private void authenticate(String username, String password) throws Exception {
        try {
            ...
            throw new Exception(ConstantVariables.USER_DISABLED, e);
        } catch (BadCredentialsException e) {
            throw new Exception(ConstantVariables.INVALID_CREDENTIALS, e);
        }
    }
}
